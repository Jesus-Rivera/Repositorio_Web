        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="7000">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active">
                    <img src="<?=URL?>img/bg-01.jpg" class="d-block img-fluid" alt="...">
                ...
                <div class="carousel-item">
                    <img src="<?=URL?>img/bg-02.jpg" class="d-block img-fluid" alt="...">
                    <div class="carousel-caption text-center d-none d-block">
                ...
                <!-- slide 3 -->
                <div class="carousel-item">
                    <img src="<?=URL?>img/form.jpg" class="d-block img-fluid" alt="...">
                    <div class="carousel-caption text-center d-none d-block">
            ...
            <div class="row justify-content-center">
                <div class="col-md-3">
                    <div class="card-deck">
                        <div class="card shadow">
                            <div class="inner">
                                <img class="card-img-top img-responsive" src="<?=URL?>img/machine.gif" class="img-fluid"
                                    alt="material 1">
                            </div>
                ...
                <div class="col-md-3">
                    <div class="card-deck">
                        <div class="card shadow" style="width: 20rem;">
                            <div class="inner">
                                <img class="card-img-top img-responsive" src="<?=URL?>img/android.gif" class="img-fluid"
                                    alt="material 1">
                            </div>
                            <div class="card-body text-center">
                ...
                <div class="col-md-3">
                    <div class="card-deck">
                        <div class="card shadow" style="width: 20rem;">
                            <div class="inner">
                                <img class="card-img-top img-responsive" src="<?=URL?>img/backend.gif" class="img-fluid"
                                    alt="material 1">
                            </div>
                            <div class="card-body text-center">
                ...
                <div class="col-md-3">
                    <div class="card-deck">
                        <div class="card shadow" style="width: 20rem;">
                            <div class="inner">
                                <img class="card-img-top img-responsive" src="<?=URL?>img/Responsive_web.gif" class="img-fluid"
                                    alt="material 1">
                            </div>
                            <div class="card-body text-center">
                ...
                <div class="item col-md-3">
                    <div class="hover3d">
                        <div class="hover3d-child">
                            <div class="team-img">
                                <img src="<?=URL?>img/2a.jpg" class="img-responsive" alt="">
                            </div>
                            <div class="info">
                                <div>
                                    <h6>Pablo</h6>
