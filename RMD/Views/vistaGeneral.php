...
<head>
	...
	<title>RMD</title>
	<!-- estilos propios -->
	<link rel="stylesheet" href="css/navbarInicioSesion.css">
	<link rel="stylesheet" href="css/mainInicioSesion.css">
	...
	<script src="js/navbarSesion.js"></script>
</head>
    		...
    		<div class="row">
    			<div class="col-12">
    				<nav class="navbar navbar-expand-md navbar-light">
    					<a class="navbar-brand" href="#" target="_blank"><img src="img/logo.png" alt=""></a>
    						...
    						<ul class="navbar-nav ml-auto py-4 py-md-0">
    							...
    							<li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
									...
									<div class="dropdown-menu">
										...
										<a class="dropdown-item" href="#">Modo Dark</a>
