    ...
    <section id="footer" class="bg-dark section-4">
        <div class="container">
            ...
            <ul class="list-inline">
                <li class="list-inline-item footer-menu"><a href="<?=URL?>main#inicio">Inicio</a></li>
                <li class="list-inline-item footer-menu"><a href="<?=URL?>main#material">Material</a></li>
                <li class="list-inline-item footer-menu"><a href="<?=URL?>main#profesores"><a href="">Profesores</a></a></li>
                <li class="list-inline-item footer-menu"><a href="<?=URL?>main#dudas">Dudas</a></li>
            </ul>
            <ul class="sci">
