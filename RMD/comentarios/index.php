...
<body>
  ...
  <div id="L">
    ...
    <center>
      <h1>Bienvenido <?php echo $_SESSION['usuario'] ?><a id="salir" href="logout.php"> (salir)</a></h1>
    </center>
    <form name="form1" method="post" action="">
      <label for="textarea"></label>
      <center>
        <p>
          <textarea required name="comentario" cols="80" rows="5" id="textarea"><?php if (isset($_GET['user'])) { ?>@<?php echo $_GET['user']; ?><?php } ?></textarea>
        </p>
        <p>
          <input class="bubbly-button" type="submit" <?php if (isset($_GET['id'])) { ?>name="reply" <?php } else { ?>name="comentar" <?php } ?>value="Comentar">
        </p>
      </center>
    </form>
